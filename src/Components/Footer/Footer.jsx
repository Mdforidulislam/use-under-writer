        ...
        <div className="bg-white">
            <div className="bg-gray-800">
                ...
                <div className="   max-w-screen-xl mx-auto px-6 py-12">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 justify-between">
                        ...
                        <div className="space-y-4">
                            ...
                            <h4 className={`text-sm text-white ${open === 1 ? '' : 'hidden md:block'}`}>
                                NAIC #: 30457 <br />
                                P.O. Box 2426 <br />
                        ...
                        <div className="space-y-4">
                            ...
                            <h4 className={`text-sm space-y-3 text-white block ${open === 2 ? '' : 'hidden md:block'}`}>
                        ...
                        <div className="space-y-4">
                            ...
                            <h4 className={`text-sm text-white ${open === 3 ? '' : 'hidden md:block'}`}>
                        ...
                        <div className="space-y-4">
                            ...
                            <h4 className={`text-sm space-y-3 text-white ${open === 4 ? '' : 'hidden md:block'}`}>
                                <span className="flex gap-4"><Image src={time} alt="logo" width={15} height={10} /> Monday - Friday, 9:00 am - 6:00 pm ET</span>
                                <span className="flex gap-4"><Image src={call} alt="logo" width={15} height={10} />+1 (248) 541-2800</span>
                                <span className="flex gap-4"><Image src={email} alt="logo" width={15} height={5} /> customerservice@usaunderwriters.com</span>
                            </h4>
                        ...
                        <div className="space-y-4">
                            ...
                            <h4 className={`text-sm space-y-3 text-white ${open === 5 ? '' : 'hidden md:block'}`}>
                                <span className="flex gap-4"><Image src={time} alt="logo" width={15} height={10} /> Monday - Friday, 9:00 am - 6:00 pm ET</span>
                                <span className="flex gap-4"><Image src={call} alt="logo" width={15} height={10} />+1 (248) 541-2800</span>
                        ...
                        <div className="space-y-4">
                            ...
                            <h4 className={`text-sm space-y-3 text-white ${open === 6 ? '' : 'hidden md:block'}`}>
                                <span className="flex gap-4"><Image src={call} alt="logo" width={15} height={10} />+1 (248) 541-2800</span>
                                <span className="flex gap-4"><Image src={email} alt="logo" width={15} height={5} /> customerservice@usaunderwriters.com</span>
                            </h4>
                        </div>
